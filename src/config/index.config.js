...
// banks endpoints
export const WESTERN_BANK_API_ENDPOINT = process.env.WESTERN_BANK_API_ENDPOINT || 'https://api.westernbank.com/check-balance';
export const EAST_BANK_API_ENDPOINT = process.env.EAST_BANK_API_ENDPOINT || 'https://api.eastbank.com/check-balance';
